...
export default function AccountantPage(){
 ...
 return <main className="accountant-shell"><header className="accountant-header"><Link href="/" aria-label="Back to dashboard"><ArrowLeft size={18}/></Link><div><span>ACCOUNTANT WORKSPACE</span><h1>Client closing desk</h1><p>Review every client, period, approval, and report from one controlled workspace. <Link href="/pilot">Open pilot tracker</Link></p></div><button onClick={addClient} disabled={busy}><Building2 size={16}/>Add client</button></header>
